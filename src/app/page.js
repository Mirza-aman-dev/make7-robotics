...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        {/* 1. Hero Section */}
        <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center pt-24 pb-12 md:pt-32 md:pb-margin-desktop px-4 sm:px-8 md:px-margin-desktop primary-glow-bg overflow-hidden" id="home">
          <div className="absolute inset-0 z-0">
            {/* Abstract tech background */}
            <div className="absolute w-full h-full bg-surface-dim bg-cover bg-center opacity-20" aria-label="A cinematic, high-contrast dark mode background featuring abstract, glowing wireframe structures and microscopic robotic components floating in a deep burgundy and black void. The lighting is dramatic, emphasizing high-fidelity translucency and futuristic technological advancement."></div>
          </div>
          <div className="relative z-10 max-w-container-max mx-auto text-center flex flex-col items-center gap-8 md:gap-stack-lg">
            <div className="flex flex-col items-center gap-6 md:gap-stack-md max-w-4xl px-4 md:px-0">
              <h1 className="font-display-lg text-4xl sm:text-5xl md:text-7xl lg:text-[84px] leading-tight text-on-surface text-gradient">
                Architecting the Future of STEM in Qatar.
              </h1>
              <p className="font-body-lg text-base sm:text-lg text-on-surface-variant max-w-2xl px-2">
                Make7 Robotics equips classrooms with cutting-edge, mobile-trainer STEM and robotics labs, engineered to inspire the next generation of innovators in Doha and beyond.
              </p>
            </div>
            <div className="flex flex-col w-full sm:w-auto sm:flex-row gap-4 md:gap-stack-md px-4 sm:px-0">
              <a className="btn-primary-glass font-label-caps text-xs md:text-label-caps text-primary px-6 md:px-8 py-3 md:py-4 rounded-full flex items-center justify-center gap-2 transition-all duration-300 w-full sm:w-auto" href="#products">
                <span>Explore Our Labs</span>
                <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
              </a>
              <a className="glass-panel font-label-caps text-xs md:text-label-caps text-on-surface px-6 md:px-8 py-3 md:py-4 rounded-full flex items-center justify-center gap-2 hover:bg-white/10 transition-colors duration-300 w-full sm:w-auto" href="#curriculum">
          ...
          <div className="max-w-container-max mx-auto flex flex-col gap-8 md:gap-stack-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-gutter auto-rows-[300px] md:auto-rows-[400px]">
              ...
              <div className="glass-panel rounded-xl overflow-hidden flex flex-col relative group lg:col-span-2">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-60 transition-opacity duration-500" alt="A highly detailed, hyper-realistic render of a modern, modular robotics training station designed for a classroom setting. The station features sleek metallic components, glowing LED indicators, and organized compartments, set against a dark, moody background with subtle red lighting accents, emphasizing a premium, high-tech B2B aesthetic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBkYOKn3RRLoD-6WsWwiji6zSDn8HKCwxNOL5U9DmR9WpVMyIfU8AtlUkCOOzPeuYBBFJfY3Lz22tCBypr3sljnl626qomuFja8-SrGfh75ufJBEyJjovNm6R4XqC4WuGWy6hhOA5Q2Iski6Ekqu5FbqOUrMBwgycohwqPUd4FI4G9zzNajzn-TRdzkKOvFQshWk2sxljFYo2cU-rWyno22nfSopDb3vCrDM9OcsCxZdtcrsncMJgPHwojrIK7HGyDpkku0uQFwrYQi" />
